...
import ouctomeimg from "@/assets/images/outcome2.svg"
import Image from "next/image"

const ProgramOutcome = () => {
    const outcomes = ["Product Ownership", "Freelacing", "Global Marketing by DAO", "Boosting Economy"]
    return (
        <section className=" mt-10 md:mt-20">
            <Wrapper>
                <div className="flex flex-col md:flex-row items-center gap-5">
                    <div className="flex-1">
                        <Image className=" object-cover " src={ouctomeimg} alt="" />
                    </div>
                    <div className="flex-1">
                        <h2 className="mt-3 text-4xl font-bold md:text-5xl whitespace-pre-line">The Outcome for Participants of the Program</h2>
                        <p className="mt-5 text-xl text-slate-600">As a graduate of this program, you will own valuable products such as Full-Stack App Templates, AR and VR Experiences, and APIs that are marketed globally by the Panaverse DAO. You will also have the opportunity to offer your services at a rate of $50 per hour, providing a path to financial stability while contributing to the growth of Pakistan's software exports.</p>
